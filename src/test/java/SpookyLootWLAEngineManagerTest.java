...
public class SpookyLootWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SpookyLootWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SpookyLootIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SpookyLootIW/InitOutcome.xml").getDocumentElement();
